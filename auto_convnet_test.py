...
X_test = preprocessor.transform(X_test) + tf.random_normal(shape = tf.shape(X_test)) * 0.7
...
print("CNN restored.")
loader.restore(sess, "./autoencoder_1000-500_128_0.7_epo_1000.ckpt")
print("Autoencoder restored.")



Test_accuracy = sess.run(accuracy, feed_dict = {X:autoencoder.reconstruct(X_test), Y_:X_test_y, keep_prob:1.0})
